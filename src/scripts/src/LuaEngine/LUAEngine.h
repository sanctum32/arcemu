...
class LuaEngine
{
	...
	public:
		...
		ARCEMU_INLINE std::unordered_map<uint32, LuaQuest*> & getLuQuestMap() { return m_qAIScripts; }
		ARCEMU_INLINE std::unordered_map<uint32, LuaInstance*> & getLuInstanceMap() { return m_iAIScripts; }
		ARCEMU_INLINE std::unordered_map<uint32, LuaGossip*> & getUnitGossipInterfaceMap() { return m_unitgAIScripts; }
		ARCEMU_INLINE std::unordered_map<uint32, LuaGossip*> & getItemGossipInterfaceMap() { return m_itemgAIScripts; }
		ARCEMU_INLINE std::unordered_map<uint32, LuaGossip*> & getGameObjectGossipInterfaceMap() { return m_gogAIScripts; }
