...
class SERVER_DECL QuestMgr :  public Singleton < QuestMgr >
{
	...
	private:
		...
		std::unordered_map<uint32, list<QuestRelation*>* > m_npc_quests;
		std::unordered_map<uint32, list<QuestRelation*>* > m_obj_quests;
		std::unordered_map<uint32, list<QuestRelation*>* > m_itm_quests;
		QuestPOIMap m_QuestPOIMap;

		std::unordered_map<uint32, list<QuestAssociation*>* > m_quest_associations;
		ARCEMU_INLINE std::unordered_map<uint32, list<QuestAssociation*>* >& GetQuestAssociationList()
		...
		template <class T> std::unordered_map<uint32, list<QuestRelation*>* >& _GetList();
...
template<> ARCEMU_INLINE std::unordered_map<uint32, list<QuestRelation*>* >& QuestMgr::_GetList<Creature>()
{return m_npc_quests;}
template<> ARCEMU_INLINE std::unordered_map<uint32, list<QuestRelation*>* >& QuestMgr::_GetList<GameObject>()
{return m_obj_quests;}
template<> ARCEMU_INLINE std::unordered_map<uint32, list<QuestRelation*>* >& QuestMgr::_GetList<Item>()
{return m_itm_quests;}
